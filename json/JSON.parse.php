...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>JSON.parse in JSON</title>
...
<div class="topics">
  ...
  <a class="active" href="JSON.parse"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> JSON.parse</a></a>
...
<h1 id="problemhead">JSON.parse in javascript</h1><br><br>

<p id="content_p">JSON.parse is used to convert the string to a javascript object.
</p><br><br>
<br><hr><br><br>
...
&lt;script>
      ...
      var str = '[ { "Name" : "jack" , "Age" : 22 } , { "Name" : "Steve", "Age" : 32 } ]';
