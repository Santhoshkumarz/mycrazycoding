...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Get JSON file data in PHP</title>
...
<div class="topics">
  ...
  <a class="active" href="json php Get data from JSON file"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Get JSON file data</a>
...
<h1 id="problemhead">Get JSON file data in PHP</h1><br><br>

<p id="content_p"><b>file_get_contents()</b> is used to get the data from already exist file and <b>json_decode()</b> function is used to convert JSON object to PHP object. Using these functions we can access the JSON file data in PHP.</p>
<br><br>
<br><hr><br><br>
