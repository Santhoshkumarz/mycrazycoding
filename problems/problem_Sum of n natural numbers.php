...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Sum of n natural numbers in Java/Python</title>
...
<h1 id="problemhead">Sum of n natural numbers</h1>
<br><br>
<p id="content_p">Problem to sum the natural numbers from 1 to n.</p>
<br><br>
