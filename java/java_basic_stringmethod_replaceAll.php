...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>string replaceAll in java</title>
    ...
    <meta name="keywords" content="array replaceall in java,char replaceall in java,example of string replaceall in java,how does replaceall work in java,how replaceall works in java,how to replaceall in java,how to use replaceall in java,how to use replaceall method in java,how to use string.replaceall in java,method replaceall in java,replaceall function in java,replaceall in java,replaceall in java 8,replaceall in java example,replaceall in java online,replaceall in java string,replaceall java code,replaceall java function,replaceall java method,replaceall java numbers,replaceall java operations,replaceall method in arraylist java,replaceall method in java list,replaceall method program in java,replaceall() in java,string replaceall in java,use of replaceall method in java,using replaceall in java,what does replaceall do in java,what is replaceall in java,replaceAll(),replaceAll() in java,replaceAll() in java in mycrazycoding">  
...
<a class="active" href="java_basic_stringmethod_replaceAll.php">replaceAll()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">replaceAll() in java</h1><br><br>
<p id="content_p">replaceAll() method used to replace the specific character or character sequence and regex(Regular Expression).</p>
<br><br> <h1 id="problemhead">syntax</h1><br><br>
    <div class="syntax">
<pre>
string.replaceAll(index)
</pre>
    </div>
...
<span class="keyword">public class</span> Main
{
       ...
       {
              String s = <span class="doublequote">"mycrazycoding2020"</span>;

              String regex = <span class="doublequote">"\\d+"</span>;  <span class="doubleslash">//regex For digit sequence</span>

              System.out.println(s.replaceAll(regex,<span class="doublequote">"-"</span>));
       }
}
</pre>
    </div></div>
...
<span class="keyword">public class</span> Main
{
       <span class="keyword">public static void</span> main(String[] args)
       { 
              String s = <span class="doublequote">"mycrazycoding#*@2020"</span>;
        
              <span class="doubleslash">//regex For special character and digit</span>
              String regex = <span class="doublequote">"[$&+,:;=?@#|'&lt>.-^*()%!]"</span>;  
