...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta name="keywords" content="how to use math.max in java,math max java list,math.max 3 values java,math.max function in java,math.max function java,math.max in array java,math.max in java,math.max in java array,math.max in java example,math.max java 3 numbers,math.max java for array,math.max java import,math.max method java,math.max() in java,math.max_value in java,math.max_value java,max of n numbers in java,use of math.max in java,what does math.max do,what does math.max do in java,what is math.max in java,Math.max() in java in mycrazycoding">
...
<a class="active" href="java_basic_mathmethod_max.php">Math.max()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">Math.max() in java</h1><br><br>
    <p id="content_p">Math.max() method used to return the maximum value of given two number.</p>
<br><br>
