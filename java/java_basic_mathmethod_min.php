...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta name="keywords" content="how to use math.min in java,math min function java,math min in java,math. min java,math.min 3 numbers java,math.min function in java,math.min import java,math.min in array java,math.min in java,math.min in java code,math.min in java example,math.min java 3 values,math.min java 8,math.min method in java,math.min method java,math.min() in java,math.min_value java,maths.min java,using math.min in java,what does math.log do in java,what does math.min do in java,what is math in java,what is math.min in java,Math.min() in mycrazycoding">
...
<a class="active" href="java_basic_mathmethod_min.php">Math.min()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">Math.min() in java</h1><br><br>
    <p id="content_p">Math.min() method used to return the minimum number of given two number.</p>
<br><br>
