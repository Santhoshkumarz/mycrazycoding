...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>string equals in java</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content=".equals in java syntax,== equals in java,check string equals in java,content equals in java,equal property in java,equals any java,equals for integer in java,equals for string in java,equals function in java,equals in array java,equals in java,equals in java 8,equals in java for string,equals in java function,equals java code,equals java method,equals java return value,equals method in java class,equals method in java example,equals method in java programming,equals method java example,equals method use in java,equals() in java,equals() in java example,equals() in java with example,method equals in java,string equals in java,string equals in java example,what does .equals do in java,what does equals method do in java,why use equals in java,equals(),equals() in java,equals() in java in mycrazycoding">  
...
<a class="active" href="java_basic_stringmethod_equals.php">equals()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">equals() in java</h1><br><br>
    <p id="content_p">equals() method used to check the both string equal or not. It's return boolean datatype.</p>
