...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>string offsetByCodePoints in java</title>
    ...
    <meta name="keywords" content="codepointcount in java,offsetbycodepoints function in java,offsetbycodepoints in java,offsetbycodepoints in java example,offsetbycodepoints java,offsetbycodepoints method in java,offsetByCodePoints(),offsetByCodePoints() in java,offsetByCodePoints() in java in mycrazycoding"> 
...
<a class="active" href="java_basic_stringmethod_offsetByCodePoints.php">offsetByCodePoints()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">offsetByCodePoints() in java</h1><br><br>
<p id="content_p">offsetByCodePoints() method used to return the length of the String.The length depend on your value.It's return index+length.</p>

<br><br> <h1 id="problemhead">syntax</h1><br><br>
    <div class="syntax">
<pre>
string.offsetByCodePoints(index,length)
</pre>
    </div>
...
public class Main
{
       public static void main(String[] args) 
       {
            ...
            int len = str.offsetByCodePoints(2,5);
...
public class Main
{
        public static void main(String[] args) 
        {
             ...
             int len = str.offsetByCodePoints(3,5);
...
public class Main
{
       public static void main(String[] args) 
       {
              ...
              int len = str.offsetByCodePoints(5,-3);
...
public class Main
{
        public static void main(String[] args) 
        {
             ...
             int len = str.offsetByCodePoints(5,9);
...
<pre>
<span class="red">java.lang.IndexOutOfBoundsException<span>
</pre>
    </div>
