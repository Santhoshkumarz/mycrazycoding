...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>string format in java</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="format method in string class in java,format method in string in java,format method of string in java,how to use string format method in java,how to use string formatter in java,string class format method in java,string format example java 8,string format in java example,string format method example in java,string format method in java,string format method in java example,string formatting in java meaning,string formatting in java print,string.format in java with example,string.format use in java,use of string format method in java,what is string formatting in java,format(),format() in java,format() in java in mycrazycoding">  
...
<a class="active" href="java_basic_stringmethod_format.php">format()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">format() in java</h1><br><br>
    <p id="content_p">format() method used to return the String format(%s means String , %f means float ,%d means Integer  and etc).</p>
...
<span class="keyword">public class</span> Main
{
       ...
       { 
              String s = <span class="doublequote">"mycrazycoding"</span>;

              System.out.print(String.format(<span class="doublequote">"site name is:%s"</span>,s));
       }
}
</pre>
    </div></div>
...
<span class="keyword">public class</span> Main
{
       <span class="keyword">public static void</span> main(String[] args)
       {
              String s = String.format(<span class="doublequote">"Number is:%.8f"</span>,<span class="digit">41.23</span>);
...
<span class="keyword">public class</span> Main
{
       <span class="keyword">public static void</span> main(String[] args)
       { 
              String s = String.format(<span class="doublequote">"Number is:%15.8f"</span>,<span class="digit">41.23</span>);
