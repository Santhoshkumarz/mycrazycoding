...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Array sort in java</title>
...
<h1 id="problemhead">Arrays.sort() in java</h1><br><br>

<p id="content_p">Arrays.sort() method used to sort the array in ascending order.In that method to perform the Quick Sort Algorithm.</p><br><br><br>

    <h2>Syntax:</h2><br><br>
    <div id="output">
    
<pre>
Arrays.sort(Variable name);
</pre>
    </div>
...
public class Main
{
      public static void main(String[] args) 
      {
            String str [] = {"Banana","Cat","Apple","Milk"};
