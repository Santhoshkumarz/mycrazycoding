...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta name="keywords" content="a constructor in java,constructor class java,constructor in a java class,constructor in function java,constructor in java,constructor in java abstract class,constructor in java and its types,constructor in java and uses,constructor in java basic program,constructor in java class,constructor in java code,constructor in java code example,constructor in java example,constructor in java example program,constructor in java exercises,constructor in java is used for,constructor in java meaning,constructor in java practice,constructor in java program,constructor in java programming language,Constructor in java,Constructor in java in mycrazycoding">
...
<br>
 ...
 <br>
  ...
  <a class="active" href="java_basic_constructor.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Constructor</a>
...
<h1 id="problemhead">Constructor in java</h1><br><br>
<p id="content_p">Constructor is a member method. Constructor is used to initialize the objects. When we create an object for class, the constructor will be call automatically.  </p><br>
<p id="content_p">The constructor name should be same as the class name. It's return nothing. We can provoid initial variable in Constructor.</p>
	  <br><br><hr><br><br>

<h1 id="problemhead">Types of Constructor</h1><br><br>
<ol id="inside">
...
<h1 id="problemhead">1. Default constructor</h1>
<br><br>
<p id="content_p">Default constructor does not have any parameters.</p><br><br><br>
<div class="box">
...
<h1 id="problemhead">2. Parameterized constructor</h1>
<br><br>
<p id="content_p">Parameterized constructor consists of parameters.</p><br><br><br>
<div class="box">
  <div class="heading">Example-1</div>
    <div class="src">
