...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>string startsWith in java</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="check startswith in java,how to check startswith in java,how to use startswith in java,how to use startswith method in java,startswith example in java,startswith function in java,startswith in java,startswith in java 8,startswith in java example,startswith in java string,startswith java function,startswith java method,startswith method in java,startswith method of string in java,startswith number java,startswith() in java,string startswith in java,string startswith in java 8,using startswith in java,what is startswith in java,startsWith(),startsWith() in java,startsWith() in java in mycrazycoding">  
...
<a class="active" href="java_basic_stringmethod_startsWith.php">startsWith()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">startsWith() in java</h1><br><br>

    <p id="content_p">startsWith() method used to check the String start with same character sequence or not. It's return boolean datatype.</p>
...
public class Main
{
       public static void main(String[] args) 
       {
              ...
              System.out.print(s.startsWith("my"));
       }
}
</pre>
    </div></div>
...
public class Main
{
       public static void main(String[] args) 
       {
              ...
              System.out.print(s.startsWith("coding"));
       }
}
</pre>
    </div></div>
...
public class Main
{
       public static void main(String[] args) 
       {
              ...
              System.out.print(s.startsWith("crazy"));
       }
}
</pre>
    </div></div>
