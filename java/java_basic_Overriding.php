...
<br>
 ...
 <br>
  ...
  <a class="active" href="java_basic_Overriding.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Method Overriding</a>
...
<h1 id="problemhead">Method overriding in java</h1><br><br>
<p id="content_p">Method overriding is to call the same method in child and parents class.</p>

<br><br><br><hr><br><br><br>
<p id="content_p">The parents class and child class also have similar method "show()". If I called the "show()"  child class method will be called.</p><br><br>
...
<p id="content_p">If you want call parents class method in overriding, you can be use super keyword.</p><br><br>
<div class="box">
