...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta name="keywords" content="example of math.pow in java,function of math.pow in java,how does math.pow work in java,how math.pow works in java,how to do math.pow in java,how to math.pow in java,how to use math pow in java,how to use math.pow,how to use math.pow in java,how to use math.pow java,import math.pow in java,math power in java,math.pow array java,math.pow code in java,math.pow function java,math.pow in java,math.pow in java 8,math.pow in java example,math.pow java code,math.pow java import,math.pow java package,math.pow method in java,math.pow method java,math.pow to java,math.pow() in java,use math.pow in java,use of math.pow in java,using math.pow in java,what does math.pow do in java,what is math.pow in java,what is the use of math pow in java,Math.pow() in java in mycrazycoding">
...
<a class="active" href="java_basic_mathmethod_pow.php">Math.pow()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">Math.pow() in java</h1><br><br>

    <p id="content_p">Math.pow() method used to return the power of base and Exponent value.</p>
<br><br>
