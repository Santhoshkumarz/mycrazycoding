...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>getFirst in LinkedList java</title>
...
<div class="content">
    ...
    <h1 id="problemhead">getFirst()</h1><br><br>
    <p id="content_p">In that method used to get the element in First position of the List.</p>
