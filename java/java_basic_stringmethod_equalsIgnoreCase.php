...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>string equalsIgnoreCase in java</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="contains with equalsignorecase in java,equals ignore case in java,equals ignore case string java,equalsignorecase contains java,equalsignorecase example,equalsignorecase function in java,equalsignorecase in java,equalsignorecase in java 8,equalsignorecase in java example,equalsignorecase in java means,equalsignorecase in java string,equalsignorecase method in java,equalsignorecase method in java example,example of equalsignorecase in java,function of equalsignorecase in java,how does equalsignorecase work in java,how to check equalsignorecase in java,how to use equalsignorecase in java,how to use equalsignorecase in java 8,string.equalsignorecase in java,use of equalsignorecase in java,what does equalsignorecase do in java,what does equalsignorecase mean in java,what is equalsignorecase in java,what is the use of equalsignorecase in java,why use equalsignorecase in java,why we use equalsignorecase in java,equalsIgnoreCase(),equalsIgnoreCase() in java,equalsIgnoreCase() in java in mycrazycoding">
...
<a class="active" href="java_basic_stringmethod_equalsIgnoreCase.php">equalsIgnoreCase()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">equalsIgnoreCase() in java</h1><br><br>
    <p id="content_p">equalsIgnoreCase() used to check the two String equal or not and It's ignore the case.</p>
