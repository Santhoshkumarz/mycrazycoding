...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>string endsWith in java</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="endswith array java,endswith command in java,endswith function in java,endswith in java,endswith in java example,endswith list java,endswith method in java,endswith method java,endswith number java,endswith() in java,explain endswith method in java,how to check string endswith in java,how to use endswith in java,how to use startswith and endswith in java,startswith and endswith in java,startswith and endswith in java example,string endswith in java,the endswith method in java,use of endswith in java,endsWith(),endsWith() in java,endsWith() in java in mycrazycoding"> 
...
<a class="active" href="java_basic_stringmethod_endsWith.php">endsWith()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">endsWith() in java</h1><br><br>
    <p id="content_p">endsWith() method used to check the String end with same character sequence or not. It's return boolean datatype.</p>
...
public class Main
{
       public static void main(String[] args) 
       {
              ...
              System.out.print(s.endsWith("coding"));
       }
}
</pre>
    </div></div>
...
public class Main
{
       public static void main(String[] args) 
       {
              ...
              System.out.print(s.endsWith("mycrazy"));
       }
}
</pre>
    </div></div>
...
public class Main
{
       public static void main(String[] args) 
       {
              ...
              System.out.print(s.endsWith("codin"));
       }
}
</pre>
    </div></div>
