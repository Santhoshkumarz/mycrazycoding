...
<br>
 ...
 <br>
  ...
  <a class="active" href="java_basic_class.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Class</a>
...
<h1 id="problemhead">Class in java</h1><br><br>
<p id="content_p">Class is a blueprint of object. Inside the class you can declare variable,method and also another class(Inner class).</p>
