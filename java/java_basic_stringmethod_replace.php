...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta name="keywords" content="array replace in java,best way to replace string in java,example of replace in java,function replace in java,how replace in java,how to do find and replace in java,how to do multiple replace in java,how to do string replace in java,how to find and replace in java,how to replace in java,how to use multiple replace in java,how to use replace function in java,how to use replace in java,how to use replace in java example,method replace in java,replace all in java example,replace in java,replace in java example,replace in java method,replace in java program,replace java,replace number java,replace() in java,string replace in java,string replace in java 8,to replace in java,using replace in java,what is replace in java,what is replace method in java,replace(),replace() in java,replace() in java in mycrazycoding">
...
<a class="active" href="java_basic_stringmethod_replace.php">replace()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">replace() in java</h1><br><br>
<p id="content_p">replace() method used to replace the specific character or character sequence in String.</p>
...
public class Main
{
       public static void main(String[] args) 
       {
              ...
              System.out.print(s.replace("coding","code"));
       }
}
</pre>
    </div></div>
...
public class Main
{
       public static void main(String[] args) 
       {
              String s = "m  y  c  r  a  z  y  c  o  d  i  n  g";
