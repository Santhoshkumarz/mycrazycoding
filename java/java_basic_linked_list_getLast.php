...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>getLast in LinkedList java</title>
...
<div class="content">
    ...
    <h1 id="problemhead">getLast()</h1><br><br>
  <p id="content_p">In that method used to Get element in Last position of the List.</p>
