...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>if,if else,else if,... in java</title>
    ...
    <meta name="keywords" content="how to use an if else statement in java,if else if block in java,if else if block java,if else if break java,if else if condition in java,if else if else in java 8,if else if example in java,if else if in java 8,if else if in java example,if else if in java program,if else if java code,if else if ladder in java example,if else if ladder program in java,if else if lambda java,if else if program in java,if else if using java 8,if else in array java,if else in arraylist java,if if else if java,if if else in java,multiple if and else if in java,nested if else if in java,syntax for if else if in java,syntax of if else if in java,if,if else in java,if,if else in java in mycrazycoding">
...
<div class="topics">
  ...
  <a class="active" href="java_basic_if.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> if,if else,..</a>
...
<h1 id="problemhead">if-statement in java</h1>
<br><br>
<p id="content_p">If statement is an decision making statement.It will be executed if the condition is true.</p>
...
<h1 id="problemhead">if-else</h1>
<br><br>
<p id="content_p">If else statement is  an decision making statement.It will be executed if the condition is true otherwise the else statement will be executed.</p>
...
public class Main
{
      public static void main(String[] args) 
      {
             ...
             if(age>18)
             {
                 System.out.println("allow the party");
             }
             else
             {
...
<h1 id="problemhead">else-if</h1>
<br><br>
<p id="content_p">else-if statement is an decision making statement. else-if statement has two or more block of statement.which block of statement is true It will be executed. if all block of statement is false else block will be executed.</p>
...
<h1 id="problemhead">nested-if else</h1>
<br><br>
<p id="content_p">Nested if else statement is an decision making statement. The if statement have a inside the if-else statement that is call nested-if else statement.</p>
