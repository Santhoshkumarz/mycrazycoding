...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>string subSequence in java</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="best subsequence program in java,find subsequence in java,find subsequence in string java,how to check subsequence in java,how to find subsequence of a string in java,how to get subsequence in java,how to use subsequence in java,longest subsequence in a string java,longest subsequence in java,longest subsequence program in java,string subsequence in java,subsequence example java,subsequence function in java,subsequence in java,subsequence in java example,subsequence java,subsequence java code,subsequence method in java,subsequence method java,subsequence numbers java,subsequence of a string in java,subsequence of string in java,subsequence program in java,subsequence() in java,what is string subsequence method in java,what is subsequence in java,subSequence(),subSequence() in java,subSequence() in java in mycrazycoding"> 
...
<a class="active" href="java_basic_stringmethod_subSequence.php">subSequence()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">subSequence() in java</h1><br><br>
<p id="content_p">subSequence() method used to return the string in specific subsequence.</p>
...
public class Main
{
       public static void main(String[] args) 
       {
              ...
              System.out.print(s.subSequence(7,13));
       }
}
</pre>
    </div></div>
...
public class Main
{
       public static void main(String[] args) 
       {
              ...
              System.out.print(s.subSequence(2,7));
       }
}
</pre>
    </div></div>
