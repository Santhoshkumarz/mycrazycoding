...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>string intern in java</title>
    ...
    <meta name="keywords" content="examples of intern in java,function of intern in java,intern in java example,intern method example in java,intern method in java,intern method program in java,intern method use in java,intern() in java,string intern in java 8,string intern method in java 8,use of intern in java,use of intern method in java,what is intern in java,what is intern method in java,what is string intern in java,what is the use of intern method in java,what is the use of intern() in java,what is the use of string intern in java,what is the use of the intern() method,when to use intern in java,when to use intern method in java,when to use string intern in java,when we use string intern in java,why we need intern method in java,why we use intern in java,why we use intern method in java,intern(),intern() in java,intern() in java in mycrazycoding">
...
<a class="active" href="java_basic_stringmethod_intern.php">intern()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">intern() in java</h1><br><br>
<p id="content_p">intern() method used to check the String with difference reference.</p>
...
<p id="content_p">In that code , s1="mycrazycoding" and s2="mycrazycoding" both String values are Equal.But difference reference.s1 stored by String pool and s2 Stored by heap memory.</p><br>
<p id="content_p">So It's return false.</p><br><br><br>
<div class="box">
...
false
    ...
    <p id="content_p">In intern method , To check the both String values only.</p>
<br><br><br>
    <div class="box">
...
public class Main
{
       public static void main(String[] args) 
       {
              String s1 = new String("mycrazycoding");

              s1 = s1.intern();

              String s2 = "mycrazycoding";
