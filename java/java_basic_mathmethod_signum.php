...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Math.signum() in java</title>
    ...
    <meta name="keywords" content="math signum function java,math.signum in java,math.signum(),Math.signum() in java,Math.signum() in java in mycrazycoding">
...
<a class="active" href="java_basic_mathmethod_signum.php">Math.signum()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">Math.signum() in java</h1><br><br>
    <p id="content_p">Math.signum() method used to return the sign of the number.</p>
<br><br>
