...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>File Delete in java</title>
    ...
    <meta name="keywords" content="delete a file in java,delete a file in java 8,delete all files in java,delete file by java,delete file from java,delete file in java,delete file in java 6,delete file in java 8,delete file in java code,delete file in java example,delete file in java program,delete file method in java,delete file using java,deleting file in java,deleting file using java,deleting files in java,how delete file in java,how to delete file in java,how to delete file in java 8,how to delete in file in java,delete file in java,delete file in java in mycrazycoding">
...
<br>
  ...
  <a class="active" href="java_basic_delete_file.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Delete-file</a>
  <br>
...
<h1 id="problemhead">Delete File in Java</h1><br><br><br>
<p id="content_p">In java programming , file delete is very simple.The below code used to delete the file in java programming.
...
<a id="download" href="zip/file_delete.zip"><i class="fa fa-download" aria-hidden="true"></i>   Download the code</a>
