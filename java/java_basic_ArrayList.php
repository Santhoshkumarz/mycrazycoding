...
<html lang="en" dir="ltr">
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="access arraylist in java,arraylist in java,arraylist in java 8,arraylist in java class,arraylist in java class example,arraylist in java code,arraylist in java create,arraylist in java example,arraylist in java example program,arraylist in java problems,arraylist in java with example programs,arraylist in java with examples,arraylist of numbers java,find in arraylist in java,java arraylist in java,when to use arraylist in java,where to use arraylist in java,why use arraylist in java,working of arraylist in java,arraylist in java,arraylist in java in mycrazycoding">
...
<br>
 ...
 <br>
  ...
  <h1 id="H1">LIST</h1>
  <a class="active" href="java_basic_ArrayList.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> ArrayList</a>
...
<div class="content">
    ...
    <h1 id="problemhead">ArrayList in java</h1><br><br>
<p id="content_p">ArrayList is a collection of data. The main reason for creating ArrayList, In java array data stored in specified size. If i want stored the data in dynamic size.I can't use array.</p>
...
public class Main
{
      public static void main(String[] args) 
      {
            ArrayList&ltString> name = new ArrayList&ltString>();
