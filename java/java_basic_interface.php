...
<br>
 ...
 <br>
  ...
  <a class="active" href="java_basic_interface.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Interface</a>
...
<h1 id="problemhead">Interface in java</h1><br><br>
<p id="content_p">Interface is a abstract class. It's means you can't define the method. interface support <b>multiple inheritance</b>. Interface is a only declare the method can not defined the method.</p>
...
<p id="content_p">In that example, <b>To define the interface method using anonymous class</b></p>
<br><br><br>
   <div class="box">
