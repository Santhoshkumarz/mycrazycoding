...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>string replaceFirst in java</title>
    ...
    <meta name="keywords" content="how to use replacefirst in java,method replacefirst in java,replace first in java,replace first in string java,replaceall in array java,replaceall in java example,replaceall java function,replacefirst example in java,replacefirst function in java,replacefirst in java,replacefirst in java example,replacefirst in string java,replacefirst java 8,replacefirst method in java,replacefirst method in java example,replacefirst() in java,string replacefirst in java example,string replacefirst method in java,string.replacefirst in java,what does replacefirst do in java,what is replacefirst in java,replaceFirst(),replacefirst() in java,replacefirst() in java in mycrazycoding">  
...
<a class="active" href="java_basic_stringmethod_replaceFirst.php">replaceFirst()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">replaceFirst() in java</h1><br><br>
    <p id="content_p">replaceFirst() method used to replace the specific character.But It's replace only for the First occurrences characters or character sequence in a String.</p>
...
public class Main
{
       public static void main(String[] args) 
       {
              ...
              System.out.print(s.replaceFirst("y","-"));
       }
}
</pre>
	  </div></div>
...
public class Main
{
       public static void main(String[] args) 
       {
              ...
              System.out.print(s.replaceFirst("a","b"));
       }
}
</pre>
    </div></div>
