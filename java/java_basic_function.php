...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Types of function in java</title>
    ...
    <meta name="keywords" content="all types of methods in java,different types of function call in java,different types of function in java,different types of methods in java,different types of methods in java with examples,four types of methods in java,function types in java example,how many types of methods are there in java,how to return multiple values of different types from a function in java,return types of methods in java,two types of methods in java,types of encryption methods in java,types of function in java,types of functions in java,types of input methods in java,types of member function in java,types of methods in interface java,types of methods in java class,types of methods in java programming,types of methods in java with examples,types of sorting methods in java,types of string methods in java,types of virtual function in java,what are the different methods in java,what are the different types of methods in java,what are the types of methods in java,types of function,types of function in java">
...
<br>
  ...
  <a class="active" href="java_basic_function.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Types of Function</a>
...
<h1 id="problemhead">Function in java</h1><br>
<p id="content_p">Function is defined as a bundle of code to perform a specific task. It will be executed, when it is called. It is used for code reusability and to reduce the lines of code.</p>     
	  <br><br><br><hr><br><br><br>
    <h1 id="problemhead">Types of Function</h1><br><br>
    <ol id="inside">
      <li>No argument no return type</li>
      <li>With argument no return type</li>
      <li>No argument with return type</li>
      <li>With argument with return type</li>
    </ol> <br><br><br><hr><br><br><br>
    <h1 id="problemhead">1. No argument no return type</h1><br><br>
<p id="content_p">This type consists of no parameter and no return type.</p>    
<br><br><br>
 <div class="box">
...
<h1 id="problemhead">2. With argument no return type</h1><br><br>
<p id="content_p">This type consists of parameter but no return type.</p>
<br><br><br>
 <div class="box">
  <div class="heading">Example</div>
    <div class="src">
...
<h1 id="problemhead">3. No argument with return type</h1><br><br>
<p id="content_p">This type does not consists of parameter but contain return type.</p>
<br><br><br>
 <div class="box">
  <div class="heading">Example</div>
    <div class="src">
...
<h1 id="problemhead">4. With argument with return type</h1><br><br>
<p id="content_p">This type consists of both parameter and return type.</p>
<br><br><br>
 <div class="box">
  <div class="heading">Example</div>
    <div class="src">
