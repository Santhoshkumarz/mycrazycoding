...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta name="keywords" content="charat in array java,charat in java 8,charat in java example,charat in java means,charat java 8,charat java code,charat java function,charat method in java example,charat method in java string,charat number java,charat program in java,charat use in java,charat() in java,example of charat in java,function of charat in java,how to charat in java,how to do charat in java,how to get charat in java,how to use charat in java,how to use charat() in java,meaning of charat in java,string charat in java,string charat method in java,use of charat in java,using charat in java,what is charat in java,what is charat() in java,what is the use of charat in java,when to use charat in java,why we use charat in java,charAt(),charAt() in mycrazycoding"> 
...
<a class="active" href="java_basic_stringmethod_charAt.php">charAt()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">charAt() in java</h1><br><br>
    <p id="content_p">charAt() method used to return the character for specific index in String.</p>
<br><br><br>
