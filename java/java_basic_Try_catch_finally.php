...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Try catch finally in java</title>
...
<h1 id="problemhead">Try catch finally in java</h1><br><br>
<p id="content_p">Try catch block used to handling the Exception. To try the code in try block. If any Exception identified, the catch block will execute.The finally block is always execute.</p>
...
public class Main
{
    ...
    {   
        ...
        {
            System.out.println("It Always Exicuted");
        }
    }
}
</pre>
