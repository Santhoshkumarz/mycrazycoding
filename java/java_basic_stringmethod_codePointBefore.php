...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>codePointBefore in java</title>
    ...
    <meta name="keywords" content="codepointbefore example java,codepointbefore java,codepointbefore method in java,codepointcount in java,codepointcount in java example,codePointBefore(),codePointBefore() in java,codePointCount() in java in mycrazycoding">
...
<a class="active" href="java_basic_stringmethod_codePointBefore.php">codePointBefore()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">codePointBefore() in java</h1><br><br><br>
<p id="content_p">codePointBefore() method used to return the before the character ascii value.</p>
<br><br>
...
<span class="keyword">public class</span> Main
{
       ...
       {
             String s = <span class="doublequote">"ASDE"</span>;

             System.out.print(s.codePointBefore(<span class="digit">1</span>));
       } 
}
</pre>
	  </div></div>
...
<span class="keyword">public class</span> Main
{
       <span class="keyword">public static void</span> main(String[] args) 
       {
             ...
             System.out.print(s.codePointBefore(<span class="digit">2</span>));
        } 
}
</pre>
    </div></div>
...
<span class="keyword">public class</span> Main
{
       <span class="keyword">public static void</span> main(String[] args) 
       {
             ...
             System.out.print(s.codePointBefore(<span class="digit">0</span>));
       }
}
</pre>
    </div></div>
...
<pre>
<span class="red">java.lang.StringIndexOutOfBoundsException</span>
</pre>
    </div><br><br><br><hr><br><br><br>
<div class="box">
...
<span class="keyword">public class</span> Main
{
       <span class="keyword">public static void</span> main(String[] args) 
       {
             ...
             System.out.print(s.codePointBefore(<span class="digit">4</span>));
       }
}
</pre>
    </div></div>
