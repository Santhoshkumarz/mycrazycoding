...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>codePointAt in java</title>
    ...
    <meta name="keywords" content="codepointat in java,codepointat java example,codepointat method in java,codepointat string java,codepointat() in java,what is codepointat in java,what is string codepointat in java,codePointAt(),codePointAt() in mycrazycoding">
...
<a class="active"  href="java_basic_stringmethod_codePointAt.php">codePointAt()</a>
...
<div class="content">
    ...
    <h1 id="problemhead">codePointAt() in java</h1><br><br>
    <p id="content_p">codePointAt() method used to return the ascii value for specific index character in the String.</p><br><br>
...
public class Main
{
       public static void main(String[] args) 
       {
             ...
             System.out.print(s.codePointAt(0));
       } 
}
</pre>
	  </div></div>
...
public class Main
{
        public static void main(String[] args) 
        {
             ...
             System.out.print(s.codePointAt(1));
        } 
}
</pre>
    </div></div>
...
public class Main
{
       public static void main(String[] args) 
       {
             ...
             System.out.print(s.codePointAt(3));
       }
}
</pre>
    </div></div>
