...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Innerclass in java</title>
    ...
    <meta name="keywords" content="anonymous inner class in java example,anonymous inner class in java with example,anonymous inner class in java with simple example,create inner class in java,example for inner class in java,how is inner class used in java,how to inner class in java,how to make inner class in java,inner class concept in java,inner class example in java,inner class in function java,inner class in java,inner class in java 8,inner class in java example,inner class in java example program,inner class in java method,inner class in java program,inner class in java simple program,inner class in java uses,inner class in java with example,inner class in java with example program,java inner class program,nested inner class in java,what inner class in java,when use inner class in java,why inner class in java,Innerclass in java,Innerclass in java in mycrazycoding">
...
<br>
 ...
 <br>
  ...
  <a class="active" href="java_basic_innerclass.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Innerclass</a>
...
<h1 id="problemhead">Inner class in java</h1><br><br>
<p id="content_p">Which class is create inside the class that is Innerclass.</p>
 <br><br><hr><br><br>
<h1 id="problemhead">Types of inner class</h1><br><br>
<ol id="inside">
  <li>Simple inner class</li>
  ...
  <li>Anonymous inner class</li>
    ...
    <h1 id="problemhead">1. Simple inner class</h1><br><br>
    <p id="content_p">The class "Inner" created inside the class "Outer". So It's Inner class. In that example, if you want access inner class you must access outer class.</p><br><br>
<div class="box">
...
<br><br><br><br><hr><br><br><br><br>
    <h1 id="problemhead">2. Method local Inner class</h1><br><br>
<p id="content_p">The inner class created inside the outer class method. you can create inner class object inside the outer class method.
</p><br><br>
<div class="box">
  <div class="heading">Example</div>
    <div class="src">
...
<h1 id="problemhead">3. Static inner class</h1><br><br>

<p id="content_p">The inner class is static that means you can access the inner class without create the object. But you should create object of outer class.</p>
...
<h1 id="problemhead">4. Anonymous inner class</h1><br><br>
<p id="content_p">Anonymous inner class used to define the method , when you are create the object.<a id="inside_a" href="java_basic_anonymous_class.php">Learn more about anonymous inner class.</a></p>
<br><br>
<div class="box">
  <div class="heading">Example</div>
    <div class="src">
