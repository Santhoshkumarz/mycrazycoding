...
<h1 id="problemhead">Throw in java</h1><br><br>
<p id="content_p">Throw keyword used to return the Exception.In that example, there are no Exception happen.But to throw the Exception in catch block.Thats a reason for using throw keyword.</p>
...
<h1 id="problemhead">Throws</h1><br><br>
<p id="content_p">Throws used to handle the Exception whole method.</p>
