...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>addFirst in LinkedList java</title>
...
<div class="content">
    ...
    <h1 id="problemhead">addFirst()</h1><br><br>
    <p id="content_p">In that method used to Add element in First position of the List.</p>
...
public class Main
{
      public static void main(String[] args) 
      {
            LinkedList&ltString> names = new LinkedList&ltString>();

            names.add("Karthik");
            names.add("Abinaya");

            names.addFirst("Kavinesh");
