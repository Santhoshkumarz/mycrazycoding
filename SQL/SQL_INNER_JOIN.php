...
<div class="topics">
  ...
  <a class="active" href="SQL_INNER_JOIN.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> INNER JOIN</a>
...
<h1 id="problemhead">INNER JOIN in SQL</h1><br><br>
...
<div class="syntax">
<pre>
SELECT * FROM Table1 INNER JOIN Table2 ON Table1.Coloum_name = Table2.Coloum_name;
</pre>      
