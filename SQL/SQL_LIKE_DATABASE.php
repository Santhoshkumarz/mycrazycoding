...
<div class="topics">
  ...
  <a class="active" href="SQL_LIKE_DATABASE.php" id="A" ><i class="fas fa-arrow-alt-circle-right"></i> LIKE</a>
...
<h1 id="problemhead">LIKE in SQL</h1><br><br>


<p id="content_p">The <span class="statement">LIKE</span> operator is used to search the data. It searches the data in pattern format.</p>
...
<div class="syntax">
<pre>
SELECT <i>ColumnName1,ColumnName2,..</i> FROM <i>TableName</i> WHERE <i>ColumnName</i> LIKE <i>Condition</i>;
</pre>      
...
<pre>
SELECT Name FROM USERS WHERE Name LIKE '__a%';
</pre>
    </div></div>
<br><br>
