...
<div class="topics">
  ...
  <a class="active" href="SQL_UPDATE.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> UPDATE</a>
...
<h1 id="problemhead">UPDATE in SQL</h1><br><br>

<p id="content_p">The <span class="statement">UPDATE</span> statement is used to modify the table data.</p>
<br><br><br>
...
<div class="syntax">
<pre>
UPDATE TableName SET <i>column1 = values1,column2=values2,..</i> WHERE <i>condition</i>;
</pre>      
...
<pre>
UPDATE USERS SET Name = "Tesla" WHERE Id = 102;
</pre>
	  </div></div>
<br><br>
...
<pre>
UPDATE USERS SET Name = "Tesla", Country = "USA" WHERE Id = 102;
</pre>
    </div></div>
<br><br>
