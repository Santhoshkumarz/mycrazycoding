...
<div class="topics">
  ...
  <a class="active" href="SQL_LEFT_JOIN.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> LEFT JOIN</a>
...
<h1 id="problemhead">LEFT JOIN in SQL</h1><br><br>
...
<div class="syntax">
<pre>
SELECT * FROM Table1 LEFT JOIN Table2 ON Table1.Coloum_name = Table2.Coloum_name;
</pre>      
