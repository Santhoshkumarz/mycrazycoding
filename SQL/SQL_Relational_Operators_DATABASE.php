...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Relational Operators in SQL</title>
...
<div class="topics">
  ...
  <a class="active" href="SQL_Relational_Operators_DATABASE.php"  id="A"> <i class="fas fa-arrow-alt-circle-right"></i>RELATIONAL OPERATOR</a> 
...
<h1 id="problemhead">Relational Operators in SQL</h1><br><br>
...
<h1 id="problemhead">1. Greater Than(>)</h1><br><br>
<div class="syntax">
<pre>
SELECT * FROM <i>TableName</i> WHERE <i>ColumnName</i> > <i>Value</i>;
</pre>      
...
<pre>
SELECT * FROM USERS WHERE Marks > 35;
</pre>
    </div></div>
<br><br>
...
<h1 id="problemhead">2. Less than(<)</h1><br><br>
...
<h1 id="problemhead">3. Greater than Equal(>=)</h1><br><br>
<div class="syntax">
<pre>
SELECT * FROM <i>TableName</i> WHERE <i>ColumnName</i> >= <i>Value</i>;
</pre>      
...
<h1 id="problemhead">4. Less than Equal(>=)</h1><br><br>
<div class="syntax">
<pre>
SELECT * FROM <i>TableName</i> WHERE <i>ColumnName</i> <= <i>Value</i>;
</pre>      
...
<h1 id="problemhead">5. Not Equal(!=)</h1><br><br>
<div class="syntax">
<pre>
SELECT * FROM <i>TableName</i> WHERE <i>ColumnName</i> != <i>Value</i>;
</pre>      
...
<h1 id="problemhead">6. Equal(=)</h1><br><br>
<div class="syntax">
<pre>
SELECT * FROM <i>TableName</i> WHERE <i>ColumnName</i> = <i>Value</i>;
</pre>      
