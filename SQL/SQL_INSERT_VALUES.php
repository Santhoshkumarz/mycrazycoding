...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>INSERT VALUES in SQL</title>
...
<div class="topics">
  ...
  <a class="active" href="SQL_INSERT_VALUES.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> INSERT VALUES</a>
...
<h1 id="problemhead">INSERT INTO in SQL</h1><br><br>




<p id="content_p">The <span class="statement">INSERT INTO</span> syntax used to insert the value in table. We can insert the value in the table in two different ways.</p>
...
<div class="syntax">
<pre>
INSERT INTO TableName VALUES(<i>values1, values2,..</i>); 
</pre>      
...
<div class="syntax">
<pre>
INSERT INTO TableName (<i>column1, column2, column3, ...</i>) VALUES (<i>value1, value2, value3, ...</i>);
</pre>      
...
<pre>
INSERT INTO USERS VALUES('Jack',23);

INSERT INTO USERS VALUES('Steve',26);

INSERT INTO USERS VALUES('Stark',19);
</pre>
	  </div></div>
<br><br><br>
...
<pre>
INSERT INTO USERS (Name,Age) VALUES ("jack",21);

INSERT INTO USERS (Name,Age) VALUES ("Stark",25);
