...
<div class="topics">
  ...
  <a class="active" href="SQL_AS_DATABASE.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> AS</a>
...
<h1 id="problemhead">AS in SQL</h1><br><br>



<p id="content_p">The <span class="statement">AS</span> statement is used to change the column name or table name in the table.</p>
...
<div class="syntax">
<pre>
SELECT  <i>ColumnName</i> AS <i>NewColumnName</i> FROM <i>TableName</i>;
</pre>      
...
<pre>
SELECT Id AS Roll-Number FROM USERS;
</pre>
	  </div></div>
<br><br>
