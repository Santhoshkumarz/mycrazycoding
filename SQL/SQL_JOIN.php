...
<div class="topics">
  ...
  <h1 id="H1">JOIN</h1>
  <a class="active" href="SQL_JOIN.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> JOIN</a>
...
<h1 id="problemhead">JOIN in SQL</h1><br><br>




<p id="content_p">The  <span class="statement">JOIN</span> is used to combine the multiple tables.</p>
...
<h1 id="problemhead">Types of join</h1>
...
<h1 id="problemhead">1. Left join</h1><br><br>

<p id="content_p">The  <span class="statement">LEFT JOIN</span> is used to return all records in the left side table and common records in the right side table.</p>
...
<h1 id="problemhead">2. Right join</h1><br><br>

<p id="content_p">The <span class="statement">RIGHT JOIN</span> is used to return all records in the right side table and common records in the left side table.</p>

<br><br><br>

<div class="image">

<img src="image/right_join.png" >
...
<h1 id="problemhead">3. Inner join</h1><br><br>

<p id="content_p">The <span class="statement">INNER JOIN</span> is used to return the common records only.</p>

<br><br><br>

<div class="image">

<img src="image/inner_join.png" >
...
<h1 id="problemhead">4. Full join</h1><br><br>

<p id="content_p">The <span class="statement">FULL JOIN</span> is used to return all records in the right side table and left side table.</p>

<br><br><br>

<div class="image">

<img src="image/full_join.png" >
