...
<div class="topics">
  ...
  <a class="active" href="SQL_UNION.php"  id="A"> <i class="fas fa-arrow-alt-circle-right"></i>UNION/UNION ALL</a>
...
<h1 id="problemhead">UNION in SQL</h1><br><br>




<p id="content_p">The <span class="statement">UNION</span> operator is used to combine the result and it removes duplicate values.</p>
...
<div class="syntax">
<pre>
SELECT column_names FROM Table1 UNION SELECT column_name FROM Table2;
</pre>      
...
<h1 id="problemhead">DEMO DATABASE</h1><br><br>
<div class="flex_table">
<div class="table1">

<p id="content_p">The table1 name is <b>cricket</b> 👇.</p>
<br><br>
...
<p id="content_p">The table2 name is <b>football 👇</b>.</p>
<br><br>
<table id="demo_database_table">
...
<pre>
SELECT Name FROM cricket UNION SELECT Name FROM football;
</pre>
	  </div></div>
<br><br><br>
...
<h1 id="problemhead">UNION ALL in SQL</h1><br><br>




<p id="content_p">The <span class="statement">UNION</span> operator is used to combine the result and it includes the duplicate values.</p>
...
<div class="syntax">
<pre>
SELECT column_names FROM Table1 UNION ALL SELECT column_name FROM Table2;
</pre>      
...
<pre>
SELECT Name FROM cricket UNION ALL SELECT Name FROM football;
</pre>
    </div></div>
<br><br><br>
