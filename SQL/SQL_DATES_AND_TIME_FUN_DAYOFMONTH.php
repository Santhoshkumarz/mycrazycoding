...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>DAYOFMONTH() function in SQL</title>
...
<h1 id="problemhead">DAYOFMONTH() in SQL</h1><br><br>


<p id="content_p">The <span class="statement">DAYOFMONTH()</span> function return the day of the month for a given date.</p>
...
<pre>
SELECT * FROM USERS WHERE DAYOFMONTH(Birth) = 21;
</pre>
	  </div></div>
<br><br><br>
