...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>SELECT VALUES in SQL</title>
...
<div class="topics">
  ...
  <a class="active" href="SQL_SELECT.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> SELECT</a>
...
<h1 id="problemhead">SELECT in SQL</h1>
<br><br>


<p id="content_p">The <span class="statement">SELECT</span> statement is used to select data from a table. The data returned is stored in a result table, called the result-set.</p>
...
<h2>DEMO DATABASE</h2><br><br>
<p id="content_p">The table name is <b>USERS</b>.</p><br><br>
<table id="demo_database_table">
