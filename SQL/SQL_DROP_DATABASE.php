...
<div class="topics">
  ...
  <a class="active" href="SQL_DROP_DATABASE.php" id="A" ><i class="fas fa-arrow-alt-circle-right"></i> DROP</a>
...
<h1 id="problemhead">DROP in SQL</h1><br><br>




<p id="content_p">The <span class="statement">DROP</span> statement is used to delete the table.</p>
...
<p id="content_p">The table is deleted.</p>
