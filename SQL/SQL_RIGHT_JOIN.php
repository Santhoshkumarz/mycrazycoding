...
<div class="topics">
  ...
  <a class="active" href="SQL_RIGHT_JOIN.php"  id="A"> <i class="fas fa-arrow-alt-circle-right"></i>RIGHT JOIN</a>
...
<h1 id="problemhead">RIGHT JOIN in SQL</h1><br><br>
...
<img src="image/right_join.png" width="70%">
...
<div class="syntax">
<pre>
SELECT * FROM Table1 RIGHT JOIN Table2 ON Table1.Coloum_name = Table2.Coloum_name;
</pre>      
