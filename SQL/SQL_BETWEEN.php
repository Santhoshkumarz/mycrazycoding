...
<div class="topics">
  ...
  <a class="active" href="SQL_BETWEEN.php"  id="A"> <i class="fas fa-arrow-alt-circle-right"></i>BETWEEN</a>
...
<h1 id="problemhead">BETWEEN in SQL</h1><br><br>



<p id="content_p">The <span class="statement">BETWEEN</span> operator is used to select the given range of data.</p>
...
<div class="syntax">
<pre>
SELECT coloum_name FROM table_name WHERE coloum_name BETWEEN value1 AND value2;
</pre>      
...
<h1 id="problemhead">NOT BETWEEN</h1><br><br>



<p id="content_p">The NOT BETWEEN operator is the opposite of BETWEEN operator.</p>
...
<div class="syntax">
<pre>
SELECT coloum_name FROM table_name WHERE coloum_name NOT BETWEEN value1 AND value2;
</pre>      
