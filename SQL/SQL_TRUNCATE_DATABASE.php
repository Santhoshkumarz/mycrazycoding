...
<div class="topics">
  ...
  <a class="active" href="SQL_TRUNCATE_DATABASE.php" id="A"><i class="fas fa-arrow-alt-circle-right"></i> TRUNCATE</a>
...
<h1 id="problemhead">TRUNCATE in SQL</h1><br><br>


<p id="content_p">The <span class="statement">TRUNCATE</span> statement is used to delete the table inside data. But it does not delete the table.</p>
