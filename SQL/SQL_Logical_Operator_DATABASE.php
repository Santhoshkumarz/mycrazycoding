...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Logical Operators in SQL</title>
...
<div class="topics">
  ...
  <a class="active" href="SQL_Logical_Operator_DATABASE.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> LOGICAL OPERATOR</a> 
  <br>
  <hr>
...
<h1 id="problemhead">Logical Operators in SQL</h1><br><br>

<p id="content_p">It used to perform the logical operation between two or more condition.</p>
...
<br><br>
<br><hr><br><br><br>
<h1 id="problemhead">1.AND</h1><br><br>
<div class="syntax">
<pre>
SELECT * FROM <i>TableName</i> WHERE <i>ColumnName1</i> = <i>Value</i> AND <i>ColumnName2</i> = <i>Value</i>...;
</pre>      
...
<pre>
SELECT * FROM USERS WHERE Name = 'Jack' AND Country = 'INDIA';
</pre>
    </div></div>
<br><br>
...
<h1 id="problemhead">2.OR</h1><br><br>
<div class="syntax">
<pre>
SELECT * FROM <i>TableName</i> WHERE <i>ColumnName1</i> = <i>Value</i> OR <i>ColumnName2</i> = <i>Value</i>...;
</pre>      
...
<pre>
SELECT * FROM USERS WHERE Name = 'Jack' OR Country = 'INDIA';
</pre>
    </div></div>
<br><br>
...
<h1 id="problemhead">3.NOT</h1><br><br>
<div class="syntax">
<pre>
SELECT * FROM <i>TableName</i> WHERE NOT <i>ColumnName</i> = <i>Value</i>;
</pre>      
...
<pre>
SELECT * FROM USERS WHERE NOT Name = 'Jack';
</pre>
    </div></div>
<br><br>
