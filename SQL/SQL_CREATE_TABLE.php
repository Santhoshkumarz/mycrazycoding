...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>CREATE TABLE in SQL</title>
...
<div class="topics">
  ...
  <a class="active" href="SQL_CREATE_TABLE.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> CREATE TABLE</a>
...
<h1 id="problemhead">SQL CREATE TABLE</h1><br><br>


<p id="content_p">The <span class="statement">CREATE TABLE</span> syntax used to create the new table.</p>
...
(
    <i>column_name1 datatype,</i>
    <i>column_name2 datatype,</i>
    .
    .
    .
);  
