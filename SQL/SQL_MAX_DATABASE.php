...
<div class="topics">
  ...
  <a class="active" href="SQL_MAX_DATABASE.php" id="A" ><i class="fas fa-arrow-alt-circle-right"></i> MAX</a>
...
<h1 id="problemhead">MAX in SQL</h1><br><br>

<p id="content_p">The <span class="statement">MAX()</span> function is used to return the largest value in the selected column.</p>
...
<div class="syntax">
<pre>
SELECT MAX(<i>ColumnName</i>) FROM <i>TableName</i>;
</pre>      
