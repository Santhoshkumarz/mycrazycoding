...
<div class="topics">
  ...
  <a class="active" href="SQL_HAVING.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> HAVING</a>
...
<h1 id="problemhead">SQL HAVING</h1><br><br>


<p id="content_p">The <span class="statement">HAVING</span> is used to filter the data using conditions with aggregate functions. You can not use the <span class="statement">WHERE</span> keyword to filter the records with aggregate functions.</p>
...
<div class="syntax">
<pre>
SELECT select_list FROM table_name GROUP BY column_name(s) HAVING condition;  
</pre> 
...
<pre>
SELECT COUNT(Name) NO_USERS,Country FROM USERS GROUP BY Country WHERE Country = "INDIA";
</pre>
    </div></div>
<br><br>
<h2>RESULT</h2><br><br>
...
<pre>
SELECT COUNT(Name) NO_USERS,Country FROM USERS GROUP BY Country HAVING Country = "INDIA";
</pre>
    </div></div>
<br><br>
