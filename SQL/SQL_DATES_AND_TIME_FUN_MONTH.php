...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>MONTH() function in SQL</title>
...
<h1 id="problemhead">MONTH() in SQL</h1><br><br>


<p id="content_p">The <span class="statement">MONTH()</span> function returns the month part for a given date.</p>
...
<pre>
SELECT * FROM USERS WHERE MONTH(Birth) = 5;
</pre>
	  </div></div>
<br><br><br>
