...
<div class="topics">
  ...
  <a class="active" href="SQL_ORDER_BY_DATABASE.php"  id="A"> <i class="fas fa-arrow-alt-circle-right"></i>ORDER BY</a>
...
<h1 id="problemhead">ORDER BY in SQL</h1><br><br>

<p id="content_p">The <span class="statement">ORDER BY</span> statement is used to sort the selected column data.</p>

<br><br>
<h1 id="problemhead">Types</h1><br><br>
<ol id="inside">
...
<br><br>
<br><hr><br><br><br>
<h1 id="problemhead">1. Ascending order</h1><br><br>
<div class="syntax">
<pre>
SELECT * FROM <i>TableName</i> ORDER BY <i>ColumnName</i> ASC;
</pre>      
...
<pre>
SELECT * FROM USERS ORDER BY Marks ASC;
</pre>
    </div></div>
<br><br>
...
<pre>
SELECT * FROM USERS ORDER BY Marks ASC LIMIT 2;
</pre>
    </div></div>
<br><br>
...
<h1 id="problemhead">2. Descending order</h1><br><br>
<div class="syntax">
<pre>
SELECT * FROM <i>TableName</i> ORDER BY <i>ColumnName</i> DESC;
</pre>      
...
<pre>
SELECT * FROM USERS ORDER BY Marks DESC;
</pre>
    </div></div>
<br><br>
