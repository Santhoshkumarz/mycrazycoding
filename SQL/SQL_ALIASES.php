...
<div class="topics">
  ...
  <a class="active" href="SQL_ALIASES.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> ALIASES</a>
...
<h1 id="problemhead">SQL ALIASES</h1><br><br>


<p id="content_p"><span class="statement">ALIASES</span> are used to give a temporary name for a table or column and it does not affect the original table structure. Using <span class="statement">AS</span> keyword we can create an alias name.</p>
...
<div class="syntax">
<pre>
SELECT <i>column_name</i> AS <i>alias_name</i> FROM <i>table_name</i>;   
</pre> 
...
<div class="syntax">
<pre>
SELECT <i>column1,column2,...</i> FROM <i>table_name</i> AS <i>alias_name</i>; 
</pre> 
...
<p id="content_p">The table name is <b>students</b>.</p>
<br><br>
...
<pre>
SELECT Mark1+Mark2+Mark3 AS Total FROM students; 
</pre>
	  </div></div>
<br><br>
...
<pre>
SELECT Id AS RegNum, Mark1+Mark2+Mark3 AS Total FROM students; 
</pre>
    </div></div>
<br><br>
