...
<div class="topics">
  ...
  <a class="active" href="SQL_CREATE_DATABASE.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> CREATE DATABASE</a>
...
<h1 id="problemhead">CREATE DATABASE in SQL</h1><br><br>
<p id="content_p">The <span class="statement">CREATE DATABASE</span> is used to create the new database.</p>
