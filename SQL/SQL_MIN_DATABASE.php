...
<div class="topics">
  ...
  <a class="active" href="SQL_MIN_DATABASE.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> MIN</a>
...
<h1 id="problemhead">MIN in SQL</h1><br><br>


<p id="content_p">The <span class="statement">MIN()</span> function is used to return the smallest value in the selected column.</p>
...
<div class="syntax">
<pre>
SELECT MIN(<i>ColumnName</i>) FROM <i>TableName</i>;
</pre>      
