...
<div class="topics">
  ...
  <a class="active" href="SQL_DISTINCT_DATABASE.php" id="A" ><i class="fas fa-arrow-alt-circle-right"></i> DISTINCT</a>
...
<h1 id="problemhead">DISTINCT in SQL</h1><br><br>


<p id="content_p">The <span class="statement">DISTINCT</span> statement is used to return the distinct value.</p>
...
<div class="syntax">
<pre>
SELECT DISTINCT <i>ColumnName1,ColumnName2,..</i> FROM <i>TableName</i>;</i>
</pre>      
