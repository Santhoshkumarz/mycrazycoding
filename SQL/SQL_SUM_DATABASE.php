...
<div class="topics">
  ...
  <a class="active" href="SQL_SUM_DATABASE.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> SUM</a>
...
<h1 id="problemhead">SUM in SQL</h1><br><br>

<p id="content_p">The <span class="statement">SUM()</span> function is used to return the summation of selected column data.</p>
...
<div class="syntax">
<pre>
SELECT SUM(<i>ColumnName</i>) FROM <i>TableName</i>;
</pre>      
