...
<div class="topics">
  ...
  <a class="active" href="SQL_DEFAULT.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> DEFAULT</a>
...
<h1 id="problemhead">DEFAULT in SQL</h1><br><br>

<p id="content_p">The <span class="statement">DEFAULT</span> statement is used to insert the default value in the specified table column while inserting the new record.</p>
<br><br><br>
...
INSERT INTO USERS(Name) VALUES ('KARTHICK');

INSERT INTO USERS(Name) VALUES ('RAJESH');
...
<h1 id="problemhead">ALTER THE DEFAULT VALUE</h1>
...
<pre>
ALTER TABLE USERS ALTER Country SET DEFAULT 'USA';
</pre>
</div></div>
<br><br><br>
<div class="box">
  <div class="heading">ORACLE</div>
    <div class="src">
    
<pre>
ALTER TABLE USERS MODIFY Country DEFAULT 'USA';
</pre>
</div></div>
...
<div class="box">
  <div class="heading">MS ACCESS</div>
    <div class="src">
...
<div class="box">
  <div class="heading">SQL SERVER</div>
    <div class="src">
...
<h1 id="problemhead">DROP THE DEFAULT VALUE</h1>
...
<pre>
ALTER TABLE USERS ALTER Country DROP DEFAULT;
</pre>
</div></div>
<br><br><br>
<div class="box">
  <div class="heading">ORACLE / SQL SERVER / MS ACCESS</div>
    <div class="src">
