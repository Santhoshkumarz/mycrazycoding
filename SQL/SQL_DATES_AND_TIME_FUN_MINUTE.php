...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>MINUTE() function in SQL</title>
...
<h1 id="problemhead">MINUTE() in SQL</h1><br><br>


<p id="content_p">The <span class="statement">MINUTE()</span> function return the minute part of a time</p>
...
<p id="content_p">The Table name is <b>USERS</b> and the TIMESTAMP format is <span class="statement">YYYY-MM-DD HH:MI:SS</span>.</p>
<br><br>
...
<table  id="demo_database_table">
  ...
  <tr>
   ...
   <tr>
    <td>2</td>
    <td>Steve</td>
    <td>2000-04-21 10:12:45</td>
  </tr>

     <tr>
    <td>3</td>
    <td>Thor</td>
    <td>1999-05-01 10:12:55</td>
  </tr>

   <tr>
    <td>4</td>
    <td>Natasha</td>
    <td>2002-05-21 11:20:35</td>
  </tr>
   ...
   <tr>
    <td>5</td>
    <td>Tony</td>
    <td>2002-11-24 11:20:36</td>
  </tr>

     <tr>
    <td>6</td>
    <td>Peter</td>
    <td>2002-09-21 11:20:40</td>
  </tr>
...
<pre>
SELECT * FROM USERS WHERE MINUTE(BIRTH) = 12;
</pre>
	  </div></div>
<br><br><br>
