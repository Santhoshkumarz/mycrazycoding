...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>HOUR() function in SQL</title>
...
<h1 id="problemhead">HOUR() in SQL</h1><br><br>


<p id="content_p">The <span class="statement">HOUR()</span> function return the hour part for a given date.</p>
...
<pre>
SELECT * FROM USERS WHERE HOUR(BIRTH) = 10;
</pre>
	  </div></div>
<br><br><br>
