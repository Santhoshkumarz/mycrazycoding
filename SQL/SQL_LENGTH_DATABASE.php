...
<div class="topics">
  ...
  <a class="active" href="SQL_LENGTH_DATABASE.php" id="A" ><i class="fas fa-arrow-alt-circle-right"></i> LENGTH</a>
...
<h1 id="problemhead">LENGTH in SQL</h1><br><br>


<p id="content_p">The <span class="statement">LENGTH()</span> function is used to return the length of the string.</p>
...
<div class="syntax">
<pre>
SELECT LENGTH(<i>ColumnName</i>) FROM <i>TableName</i>;
</pre>      
