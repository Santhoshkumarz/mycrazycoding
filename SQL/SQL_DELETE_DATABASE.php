...
<div class="topics">
  ...
  <a class="active" href="SQL_DELETE_DATABASE.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> DELETE</a>
...
<h1 id="problemhead">DELETE in SQL</h1><br><br>


<p id="content_p">The <span class="statement">DELETE</span> statement is used to delete the specified data in the table.</p>
