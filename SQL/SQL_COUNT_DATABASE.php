...
<div class="topics">
  ...
  <a class="active" href="SQL_COUNT_DATABASE.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> COUNT</a>
...
<div class="content">
<h1 id="problemhead">COUNT in SQL</h1><br><br>


<p id="content_p">The <span class="statement">COUNT()</span> function is used to return the number of rows in the selected column.</p>
...
<div class="syntax">
<pre>
SELECT COUNT(<i>ColumnName</i>) FROM <i>TableName</i>;
</pre>      
