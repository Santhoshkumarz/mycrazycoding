...
<div class="topics">
  ...
  <a class="active" href="SQL_FULL_JOIN.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> FULL JOIN</a>
  <br>
  <hr>
...
<h1 id="problemhead">FULL JOIN in SQL</h1><br><br>
...
<div class="syntax">
<pre>
SELECT * FROM Table1 FULL JOIN Table2 ON Table1.Coloum_name = Table2.Coloum_name;
</pre>      
...
<h1 id="problemhead">DEMO DATABASE</h1><br><br><br>
...
<div class="table1">
  ...
  <p id="content_p">The table1 name is <b>cricket</b> 👇.</p><br><br>
...
<div class="table2">
  <p id="content_p">The table2 name is <b>football</b> 👇.</p><br><br>
<table id="demo_database_table">
...
<p id="content_p">If your database does not support FULL JOIN, you can use <b>UNION ALL</b> to achieve FULL JOIN.</p>

<br>

<span class="center"><p id="content_p">FULL JOIN = (LEFT JOIN) <b>UNION ALL</b> (RIGHT JOIN)</p></span>
</div>
