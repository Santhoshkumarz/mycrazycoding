...
<div class="topics">
  ...
  <a class="active" href="SQL_In.php"  id="A"> <i class="fas fa-arrow-alt-circle-right"></i>IN/NOT IN</a>
...
<h1 id="problemhead">IN in SQL</h1><br><br>



<p id="content_p">The <span class="statement">IN</span> operator is used to perform specify multiple values in a WHERE clause. It's like multiple OR conditions.</p>
...
<div class="syntax">
<pre>
SELECT coloum_name FROM table_name WHERE coloum_name IN (value1,value2,..);
</pre>      
...
<pre>
SELECT * FROM USERS WHERE AGE IN (26,18);
</pre>
	  </div></div>
<br><br><br>
...
<h1 id="problemhead">NOT IN</h1><br><br>



<p id="content_p">The <span class="statement">NOT IN</span> operator is the opposite of <span class="statement">IN</span> operator.</p>
...
<div class="syntax">
<pre>
SELECT coloum_name FROM table_name WHERE coloum_name NOT IN (value1,value2,..);
</pre>      
...
<pre>
SELECT * FROM USERS WHERE AGE NOT IN (26,18);
</pre>
	  </div></div>
<br><br><br>
