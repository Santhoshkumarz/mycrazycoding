...
<div class="topics">
  ...
  <a class="active" href="SQL_WHERE.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> WHERE</a>
...
<h1 id="problemhead">WHERE in SQL</h1><br><br>



<p id="content_p">The <span class="statement">WHERE</span> statement is used to filter the data using conditions.</p>
...
<div class="syntax">
<pre>
SELECT * FROM <i>TableName</i> WHERE <i>Column_Name = Values</i>; 
</pre>      
