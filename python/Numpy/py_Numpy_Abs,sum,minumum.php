...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>abs,sum,min,max,sorted methods in Numpy</title>
  ...
  <a  class="active" href="py_Numpy_Abs,sum,minumum.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i>  Abs, sum, min, max, sorted</a>
...
<h2>abs method in numpy</h2><br><br>
<p id="content_p">abs function is used to convert the negative number into positive number.</p>
<br><br><br>
<div class="box">
...
[3 9 5 7 1]
 ...
 <h2>sum method</h2><br><br>
 <p id="content_p">sum function is used to print the sum of the values by given number.
It will add all the values.</p>
<br><br><br>
<div class="box">
  <div class="heading">Example</div>
    <div class="src">
...
15
    ...
    <h2>min method</h2><br><br>

<p id="content_p">min function is used to find the minimum value of the given input.</p>
<br><br><br>
<h2>Output</h2>
 <br><br>
<div class="box">
...
1
    ...
    <h2>max method</h2><br><br>
<p id="content_p">max function is used to find the maximum value of the given input.</p>
<br><br><br>
...
9
    ...
    <h2>sorted method</h2><br><br>
<p id="content_p">sorted function is used to convert the given number into Ascending order format.</p>
<br><br><br>
<div class="box">
