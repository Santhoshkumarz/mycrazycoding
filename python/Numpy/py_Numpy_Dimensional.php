...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Dimensional in Numpy</title>
  ...
  <a class="active" href="py_Numpy_Dimensional.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Dimensional</a>
...
<h1 id="problemhead">Dimensional in Numpy</h1><br><br>
<p id="content_p">Dimensional have 1D,2D,3D....etc. 1D means have n number of items. 2D,3D...etc have rows and columns.</p>
