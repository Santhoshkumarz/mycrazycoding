...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Assignment Operator in Numpy</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="assignment operator in numpy,assignment operator in numpy in python,addition assignment operator in numpy,substraction assignment operator in numpy,multiplication assignment operator in numpy,division assignment operator in numpy,assignment operator in numpy in mycrazycoding">
 ...
 <div class="sidebar" id="side">
  ...
  <a  class="active" href="py_Numpy_Assignment Operator.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Assignment Operator</a>
...
<h1 id="problemhead">Assignment Operator in Numpy</h1><br><br>
<p id="content_p">"=" is a symbol of assignment operator.It will assign the values to the variable.we do the mathematical operation in assignment operator also.</p>
<br><br><br><hr><br><br><br>

    <h2>Addition Assignment operator( <span class="green">+=</span> )</h2>
    <br><br><br>
...
[2 3 4]
    ...
    <h2>Substraction Assignment operator( <span class="green">-=</span> )</h2>
    <br><br><br>
...
[0 1 2]
    ...
    <h2>Multiplication Assignment operator( <span class="green">*=</span> )</h2>
    <br><br><br>
...
[2 4 6] 
    ...
    <h2>Floor division Assignment operator( <span class="green">//=</span> )</h2>
    <br><br><br>
...
[1 2 3]
    ...
    <h2>Modulo Assignment operator( <span class="green">%=</span> )</h2>
    <br><br><br>
...
[0 1 2]  
    ...
    <h2>Power Assignment operator( <span class="green">**=</span> )</h2>
    <br><br><br>
