...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Finding GCD in Numpy</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="finding gcd in python,gcd function in numpy,gcd function in python,gcd function numpy,gcd in numpy,gcd in python,gcd python numpy,gcd with numpy,greatest common divisor in numpy,greatest common divisor in python,np.gcd,numpy extended gcd,numpy gcd,numpy gcd float,numpy gcd function,numpy gcd of array,numpy gcd reduce,numpy greatest common divisor,numpy has no attribute gcd,numpy in greatest common divisor is,numpy in greatest common divisor of,python numpy gcd,finding gcd in numpy in mycrazycoding">
  ...
  <a  class="active" href="py_Numpy_Finding GCD.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Finding GCD</a>
...
<h1 id="problemhead">Finding GCD in Numpy</h1><br><br>
