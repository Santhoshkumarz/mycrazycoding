...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Array size in Numpy</title>
  ...
  <hr>
     ...
     <h1 id="H1">METHODS</h1>
  <a  class="active" href="py_Numpy_Size.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Size</a>
...
<h1 id="problemhead">Array size in numpy</h1><br><br>
<p id="content_p">Size function is used to find the length of the given input. It will print the output in an integer value format.</p>
