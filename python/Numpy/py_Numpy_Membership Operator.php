...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Membership Operator in Numpy</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="membership operator in numpy,in membership operator in numpy,not in membership operator in numpy,in operator in numpy,not in operator in numpy,in numpy,not in numpy,membership operator in numpy in mycrazycoding,membership operator in numpy in python in mycrazycoding">
  ...
  <a  class="active" href="py_Numpy_Membership Operator.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Membership Operator</a>
  <br>
  <hr>
...
<h1 id="problemhead">Membership Operator in Numpy:</h1><br><br>
<p id="content_p">Membership operator is used to find the given (number or string) is present in the (list,tuple,string,set,dictionary) or not.</p>
<br><br><br><hr><br><br><br>

    <h2>in operator( <span class="green">in</span> )</h2>
    <br><br><br>
...
True  
    ...
    <h2>not in operator( <span class="green">not in</span> )</h2>
    <br><br><br>
