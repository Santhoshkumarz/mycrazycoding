...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta name="keywords" content="example of regular expression in python,exercise on regular expression in python,find regular expression in python,functions of regular expression in python,how to create regular expression in python,how to do regular expression in python,how to give regular expression in python,how to import regular expression in python,how to import regular expression in python 3,how to match regular expression in python,if condition with regular expression in python,list of regular expression in python,regular expression in python 3 examples,regular expression in python example,regular expression in python example code,regular expression in python example program,regular expression in python in mycrazycoding">
...
<h1 id="problemhead">Regular Expression in python</h1>
<br><br>
<p id="content_p">It is used to find a particular pattern in an string. It is mainly used to split and search.</p>

<br><br><br><hr><br><br><br>
 <h1 id="problemhead">Regular Expression concepts</h1><br>
 
    <ol>
      
  
<li><a id="LC" href="py_Regular_Expression_Match.php">Match</a></li>
<li><a id="LC" href="py_Regular_Expression_Search.php">Search</a></li>
<li><a id="LC" href="py_Regular_Expression_Findall.php">Findall</a></li>
<li><a id="LC" href="py_Regular_Expression_Split.php">Split</a></li>
<li><a id="LC" href="py_Regular_Expression_Sub.php">Sub</a></li>
<li><a id="LC" href="py_Regular_Expression_Compile.php">Compile</a></li>
<li><a id="LC" href="py_Regular_Expression_Types.php">Types</a></li>
<li><a id="LC" href="py_Regular_Expression_Curly_Brackets.php">Curly Brackets {}</a></li>
<li><a id="LC" href="py_Regular_Expression_Square_Brackets.php">Square Brackets []</a></li>
<li><a id="LC" href="py_Regular_Expression_Start_and_end.php">Start and end</a></li>
  </ol>
