...
<html lang="en" dir="ltr">
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="bin function in python, bin function in python 3, bin function python, bin function python 3, function in python example, how to use bin function in python, how to use bin in python, python bin function, what is bin function in python, what is bin in python, bin function in python in mycrazycoding, bin function in mycrazycoding">
...
<a class="active" href="py_method_Built in Functions_bin.php">bin()</a>
...
<h1 id="problemhead">bin() in Python</h1><br> <br> 
<p id="content_p">bin function is used to convert the number into binary value as zero's and one's format. It will return the output in an string format.</p><br><br> <br>
