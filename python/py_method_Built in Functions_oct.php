...
<html lang="en" dir="ltr">
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="oct function in python, oct function python, oct in python, oct method in python, oct method python, oct to python, oct with python, oct(x) python, octal to decimal in python, octree python, what does oct do in python, oct function in python in mycrazycoding, oct function in mycrazycoding">
...
<a class="active" href="py_method_Built in Functions_oct.php">oct()</a>
...
<h1 id="problemhead">oct() in Python</h1><br><br>
<p id="content_p">oct function is used to convert the given value into octal format. It will return the output in an string format.</li>
</ol><br><br><br>
