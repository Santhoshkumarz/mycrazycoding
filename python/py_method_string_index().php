...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>string index in python</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="can you index strings in python, compare string index in python, find a string index in python, find all index of character in string python, find all index of element in string python, find all index of word in string python, find char index in string python, find index of a string in a list python, find index of character in string python, find index of element in python string, find index of element in string python, find string index in python, how to find the index of a string, string index in python in mycrazycoding, string index in mycrazycoding">
...
<a class="active" href="py_method_string_index().php">string index()</a>
...
<a href="py_method_string_replace().php">string replace()</a>
...
<h1 id="problemhead">string.index() in python</h1><br><br>
<p id="content_p">String index is used to find the particular character of an index values of the given string.</p>
<br><br><br>
<h2>Syntax:</h2><br><br>
<div class="syntax">
<pre>
string.index(character) or string.index(string)
</pre>
