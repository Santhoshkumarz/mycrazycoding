...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>string split in python</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="can you split string in python, how do you split a string in python, how do you split a string in python 3, how split string in python, how to split string using python, how to split string variable in python, split each word in string python, split method of string in python, split string in list python, string split method in python, string split method python, string split method python 3, string split n python, string split in python in mycrazycoding, string split in mycrazycoding">
...
<a class="active" href="py_method_string_split().php">string split()</a>
...
<h1 id="problemhead">string.split() in python</h1><br> <br> 
<p id="content_p">String split is used to split the given single character or set of character in the given string. It will finally converts the string into split.</p>
<br> <br> <br>
<h2>Syntax:</h2> <br> <br> <br>
<div class="syntax">
<pre>
string.split(separactor)
</pre>
