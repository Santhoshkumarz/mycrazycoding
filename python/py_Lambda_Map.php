...
<html lang="en" dir="ltr">
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="difference between map and lambda in python,how to use map and lambda in python,lambda and map function in python,lambda and map in python,lambda and map in python 3,lambda filter reduce and map in python,lambda map and filter in python,lambda map filter and reduce in python,lambda map python example,lambda map python list,lambda map reduce python,lambda with map in python,map function and lambda expression in python to replace characters,what is map and lambda in python,lambda and map in python,lambda and map in python in mycrazycoding">
...
<h1 id="problemhead">Map in python</h1><br><br>
<p id="content_p">map() function is used to apply a given function on all the iterable items(list,tuple,etc) and return the output in a list.</p>
...
<div class="box">
  <div class="heading">Map Power</div>
    <div class="src">
<pre>
l = ( 2, 3, 10)
...
<div class="box">
  <div class="heading">Map length</div>
    <div class="src">
<pre>
l = [ "my", "crazy", "coding"]
