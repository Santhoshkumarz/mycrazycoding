...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>string rsplit in python</title>
...
<a class="active" href="py_method_string_rsplit().php">string rsplit()</a>
...
<h1 id="problemhead">string.rsplit() in python</h1><br> <br>
<p id="content_p">String rsplit is used to split the given single character or set of character in the given string. It will finally converts the string into list.</p>
<br> <br> <br>
