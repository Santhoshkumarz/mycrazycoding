...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Arbitrary arguments function in python</title>
...
<div class="sidebar" id="side">
  ...
  <hr>
    ...
    <a  class="active" href="py_function_Arbitrary_arguments.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Arbitrary arguments function</a>
...
<h1 id="problemhead">Arbitrary arguments function in python</h1><br>
<br>
<p id="content_p">Arbitrary arguments allows us to give zero or multiple parameters to the function. If we don't know how many parameters are going to use, then we go for Arbitrary arguments.</p><br>

<p id="content_p">In Arbitrary arguments each and every elements are stored in list format.</p>
