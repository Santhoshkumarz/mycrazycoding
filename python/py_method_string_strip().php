...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>string strip in python</title>
...
<a class="active" href="py_method_string_strip().php">string strip() </a>
...
<h1 id="problemhead">string.strip() in python</h1><br><br>
<p id="content_p">String strip is used to remove the given character or set of character in the given string.</p>
<br><br><br>
