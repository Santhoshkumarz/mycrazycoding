...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta name="keywords" content="function in python 3,function in python example, function in python program,function in python addition,function in python return,function in python return,function in python with arguments">
...
<div class="sidebar" id="side">
  ...
  <a class="active" href="py_file_Handling.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> File Handling</a>
  <hr>
  <h1 id="H1">MODULES</h1>
...
<h1 id="problemhead">File handling in python</h1><br>
<br>
<p id="content_p"></p>
...
<h1 id="problemhead">Create file</h1><br>
<br>

<p id="content_p">"x"--> It is used to create a python file.</p>
...
<h1 id="problemhead">Write file</h1><br>
<br>

<p id="content_p">write()--> It is used to write a python file.</p>
...
f.write("Welcome to Mycrazycoding")
...
<h1 id="problemhead">Read file</h1><br>
<br>

<p id="content_p">Read-->f.read()--> It is used to read a python file.</p>
...
<h1 id="problemhead">Delete file</h1><br>
<br>

<p id="content_p">Delete-->remove()--> It is used to delete a python file.</p>
