...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Tuple method in python</title>
    ...
    <meta name="keywords" content="tuple in python,count all elements in tuple python, count element in tuple python, count elements in tuple python, count in tuple in python, count method in tuple python, count number of elements in tuple python, count of tuple in python, count values in tuple python, find count in tuple python, how to count a tuple in python, how to count tuple in python,tuple index of python, tuple index in python in mycrazycoding, tuple index in mycrazycoding">
 ...
 <div class="sidebar" id="side">
  ...
  <a href="py_basic_Arrays.php" id="A" ><i class="fas fa-arrow-alt-circle-right"></i> Arrays</a>
  ...
  <a  class="active"  href="py_methods_tuple_methods.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Tuple methods</a>
  <a href="py_methods_set_methods.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Set methods</a>
  <a href="py_methods_set_methods.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Dictionary  methods</a>
  ...
  <hr>
    ...
    <a  href="py_function_Passing_a_list.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Passing a list as an arguments</a>
    <a  href="py_function_Lambda_function.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Lambda function</a>
  ...
  <a href="py_file_handling_Create_file.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Create-file</a>
  <a href="py_file_handling_Write_file.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Write-file</a>
  <a href="py_file_handling_Read_file.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Read-file</a>
  <a href="py_file_handling_Delete_file.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Delete-file</a>
  ...
  <a href="py_Exception_Handling.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Exception Handling</a>
  <hr>
  <h1 id="H1">MODULES</h1>
...
<h1 id="problemhead">Tuple in python</h1><br><br>
<p id="content_p">Tuple is immutable and we can't change the values.It takes less memory space and It is faster(Time).</p>
	  <br>
<br><br>
<h1 id="problemhead">Tuple methods</h1><br><br>
<ol>
  <li>count</li>
  <li>index</li>
</ol>
...
<h1 id="problemhead">1. count()</h1><br><br>
<p id="content_p">"count()" function is used to return the number of count of the specified value in the tuple.</p>
<br><br><br>
...
2
    ...
    <h1 id="problemhead">2. index()</h1><br><br>
<p id="content_p">"index()" function is used to find the index of the specified value in the tuple.</p>
<br><br><br>
<h2>Syntax:</h2><br><br><br>
<div class="syntax">
<pre>
