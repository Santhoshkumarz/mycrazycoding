...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Sub in Regular Expression python</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="how to use re.sub in python,python regular expression sub example,python regular expression sub function,python regular expression sub group,regular expression in python sub,regular expression re.sub in python,regular expression sub in python,s in regular expression python,sub in regular expression python,sub regular expression python,sub regular expression in python,regular expression sub in python,regular expression sub in mycrazycoding,sub regular expression in mycrazycoding">
...
<h1 id="problemhead">Sub in python</h1><br><br>
<p id="content_p">"sub" is one of the function of "re" module.  This function is used to search and insert the specified thing in between the string in a very fast and efficient manner.  While searching it will insert the specified thing in the string whenever the "re" object is found in the string.</p>
<br>
  <br><br><hr><br><br><br>
<div class="box">
...
r = re.sub(r "welcome" , "I love you" , s)
