...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>string zfill in python</title>
...
<a class="active" href="py_method_string_zfill().php">string zfill()</a>
...
<h1 id="problemhead">string.zfill() in python</h1><br><br>
<p id="content_p">String zfill is used to fill the zero('0') in the left side of the given string based on the given index.</p>
<br><br><br>
