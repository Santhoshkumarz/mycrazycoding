...
<html lang="en" dir="ltr">
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="divmod function in python, divmod function in python 3, divmod function in python example, divmod in python 3, divmod python example, divmod() in python, divmod function in python in mycrazycoding, divmod function in mycrazycoding">
...
<a class="active" href="py_method_Built in Functions_divmod.php">divmod()</a>
...
<h1 id="problemhead">divmod() in Python</h1><br><br>
<p id="content_p">divmod function is used to takes two values as an input and it will find the division and quotient values. It will print the output in an tuple format.</p><br><br><br>
