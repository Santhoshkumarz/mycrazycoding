...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>string capitalize in python</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="capitalize a string in python, capitalize all words in string python, capitalize string in list python, capitalize string input python, how to capitalize a string in python 3, how to capitalize the first letter in python, python capitalize all letters in string, python capitalize character in string, python capitalize letter in string, string capitalize each word python, string capitalize in python, string capitalize python 3, what is string capitalize in python, string capitalize in python in mycrazycoding, string capitalize in mycrazycoding">
...
<a class="active" href="py_method_string_capitalize().php">string capitalize()</a>
...
<h1 id="problemhead">string.capitalize() in python</h1><br><br>

<p id="content_p">String capitalize is used to capitalize the first character of an given string.</p>
