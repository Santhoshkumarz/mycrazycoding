...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>string lower in python</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="how to lower a string in python, how to lower string in python, lower a string in python, python string to lowercase, string lower function in python, string lower function python, string lower in python, string lower method in python, string lower python 2, string lowercase in python, string.lower in python, string.lower in python 3, string.lower() python method, string lower in python in mycrazycoding, string lower in mycrazycoding">
...
<a class="active" href="py_method_string_lower().php">string lower()</a>
...
<h1 id="problemhead">string.lower() in python</h1><br><br>
<p id="content_p">String lower is used to convert the given string into lowercase character.</p>
<br><br><br>
