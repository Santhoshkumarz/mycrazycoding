...
<div class="sidebar" id="side">
  ...
  <hr>
    ...
    <a  class="active" href="py_function.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Function</a>
...
<h1 id="problemhead">Function in python</h1><br>
<br>
<p id="content_p">Function is a block of statement,It will be executed whenever it is called in the program.</p>
