...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>string partition in python</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="how to partition a string in python, how to partition string in python, partition a string in python, partition method in python string, str.partition python, string partition in python, string partition python example, string partition in python, string partition in python in mycrazycoding, string partition in mycrazycoding">
...
<a class="active" href="py_method_string_partition().php">string partition()</a>
...
<h1 id="problemhead">string.partition() in python</h1><br><br>
<p id="content_p">String partition is used to split the given single character or set of character in the given string.</p>
<br><br><br>
