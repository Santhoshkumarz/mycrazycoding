...
<div class="sidebar" id="side">
  ...
  <a   class="active" href="py_basic_print.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Print</a>
...
<p id="content_p">Print function is used to print the statement that we have given in the bracket.</p>
