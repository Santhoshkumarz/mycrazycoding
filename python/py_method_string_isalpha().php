...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>string isalpha in python</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="isalpha function in python, isalpha in python, isalpha in python 3, isalpha string in python, python string isalpha, s.isalpha() python, str.isalpha in python, string isalpha python 3, string.isalpha python, use isalpha in python, use of isalpha in python, using isalpha in python, string isalpha in python in mycrazycoding, string isalpha in mycrazycoding">
...
<a class="active" href="py_method_string_isalpha().php">string isalpha()</a>
...
<h1 id="problemhead">string.isalpha() in python</h1><br><br>
<p id="content_p">String isalpha is used to check only the alphabets present in the string or not.</p>
<br><br><br>
