...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>String title in python</title>
...
<a class="active" href="py_method_string_title().php">string title()</a>
...
<h1 id="problemhead">string.title() in python</h1><br><br>
<p id="content_p">String title is used to convert the each first character in all the words into uppercase character in the given string.</p>
<br><br><br>
