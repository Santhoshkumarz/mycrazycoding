...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Combinatoric iterators in python</title>
   ...
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="combinatorial python,combinatorics function in python,combinatorics in python,combinatorics in python itertools,combinatorics number python,combinatorics python list,generating functions combinatorics python,python combinatorial functions,python combinatorial list,python combinatorial number,python combinatorial testing,python combinatorics,python combinatorics function,python combinatorics itertools,python combinatorics list,python combinatorics math,python combinatorics module,python combinatorics string,combinatoric in python,combinatoric in python in mycrazycoding">
...
<div class="sidebar" id="side">
  ...
  <a class="active" href="py_Combinatoric_Iterators.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Combinatoric Iterators</a>
...
<h1 id="problemhead">Combinatoric iterators in python</h1>
<br><br>
<p id="content_p">It is an recursive generators. It is used to simplify the functions. It is memory efficient.</p>
...
<br><br><br><hr><br><br><br>
 ...
 <h1 id="problemhead">Combinatoric iterators concepts</h1><br><br><br>
 
    <ol>
      
  
<li><a id="LC" href="py_Combinatoric_iterators_Product.php">Product</a></li>
<li><a id="LC" href="py_Combinatoric_iterators_Permutations.php">Permutations</a></li>
<li><a id="LC" href="py_Combinatoric_iterators_Combinations.php">Combinations</a></li>
<li><a id="LC" href="py_Combinatoric_iterators_Combination_with_replacement.php">Combination with replacement</a></li>
