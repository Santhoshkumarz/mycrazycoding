...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Split in Regular Expression python</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="how to split a string using regular expression in python,python split regular expression example,regular expression split in python,regular expression to split string in python,split function with regular expression in python,split in re python,split in regex python,split in regular expression in python,split regex in python,split string using regular expression in python,split using regular expression python,split vs regular expression python,split with regular expression in python,split with regular expression python,split regular expression in python,split regular expression in python in mycrazycoding">
...
<h1 id="problemhead">Split in python</h1><br><br>
<p id="content_p">"split" is one of the function of "re" module. This function is used to search split the string in a very fast and efficient manner.  While searching it will split the string when each and every "match" object is found in the string. It will return the output in a form of list.</p>
<br>
  <br><br><hr><br><br><br>
   <div class="box">
