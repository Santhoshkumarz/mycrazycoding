...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>set difference_update() in python</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="difference between add and update in python set, difference_update in python, set difference in place python, set difference in python list, set difference python array, set difference python code, set difference python complexity, set difference python example, set difference python implementation, set difference python order, set difference python source, set difference python strings, set difference_update python, set difference_update in python in mycrazycoding, set difference_update in mycrazycoding">
...
<a class="active" href="py_method_set_difference_update().php">difference_update() </a>
...
<h1 id="problemhead">set.difference_update() in python </h1><br><br>
<p id="content_p">"difference_update()" function is used to update the element which is not common in given two set.It will store it in the specified set.</p>
<br>
<br><br><h2>Syntax:</h2><br><br><br>

<div class="syntax">
<pre>
set.difference_update(set_value)
</pre>
