...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Takewhile in python</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="example of takewhile in python,itertools takewhile python 2,itertools takewhile python 3,itertools.takewhile,itertools.takewhile in python,takewhile dropwhile python,takewhile in python,takewhile method in python,takewhile python 3,takewhile python example,takewhile python function,takewhile itertools in python,itertools takewhile in python,takewhile itertools in python in mycrazycoding,itertools takewhile in python in mycrazycoding">
...
<h1 id="problemhead">Takewhile in python</h1><br><br>
<p id="content_p">Takewhile() is used to perform considering an item from the iterable until the specicified predicted value becomes false for the first time.</p>
...
a = list(takewhile(lambda x : x < 3, l))
...
a = list(takewhile(lambda x : x < 5, l))
