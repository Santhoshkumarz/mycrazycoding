...
<html lang="en" dir="ltr">
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="example of int function in python, how to use int function in python, how to use int() in python, int built in function python, int function in python, int function in python 2.7, int function in python 3, int function in python with example, int function input python, int function on python, int function python example, is int function in python, use of int function in python, int function in python in mycrazycoding, int function in mycrazycoding">
...
<a class="active" href="py_method_Built in Functions_int.php">int()</a>
...
<h1 id="problemhead">int() in Python</h1><br><br>
<p id="content_p">int function is used to convert the given value into integer value format.</li>
</ol><br><br><br>
