...
<html lang="en" dir="ltr">
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="function of ord in python, how to use ord function in python, how to use ord() in python, how to use the ord function in python, ord chr in python, ord function in python, ord function in python 2.7, ord function in python 3, ord function python example, ord in python, ord keyword in python, what is ord function in python, what is ord() in python, ord function in python in mycrazycoding, ord function in mycrazycoding">
...
<a class="active" href="py_method_Built in Functions_ord.php">ord()</a>
...
<h1 id="problemhead">ord() in Python</h1><br><br>
<p id="content_p">ord function is used to take the input as an character and it will convert into an unicode point format in the ascii value table.</p><br><br><br>
