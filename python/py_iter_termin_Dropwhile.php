...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Dropwhile in python</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="dropwhile function in python,dropwhile in python,dropwhile method in python,dropwhile python,dropwhile python 3,itertools.dropwhile,itertools.dropwhile in python,python dropwhile,python dropwhile example,python dropwhile not working,python itertools dropwhile,takewhile dropwhile python,dropwhile itertools in python,dropwhile itertools in python,itertools dropwhile in python,dropwhile itertools in python in mycrazycoding,itertools dropwhile in python in mycrazycoding">
...
<h1 id="problemhead">Dropwhile in python</h1><br><br>
<p id="content_p">dropwhile() function is used to drop the element until the condition is false. It return all the elements once the false condition occurs.</p>
<br>
...
a = list(dropwhile(lambda x : x < 3,l))
...
a = list(dropwhile(lambda x : x<5, l))
...
a = list(dropwhile(lambda x : x % 2 != 0, l))
