...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta name="Keywords" content="type casting in python float to int,type casting in python string to int,type casting in python example,type casting in python meaning,type casting in python to string,type casting in python 3,type casting python array,what are all the typecasting possible in python,type casting in python,type casting in mycrazycoding">
...
<div class="sidebar" id="side">
  ...
  <a class="active" href="py_basic_type_casting.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Type casting</a>
...
<h1 id="problemhead">Type casting in python</h1><br><br>

<p id="content_p">It is used to convert the data types like int,float,string.It can also performs the arithmetic operators to different data types.</p>
<br><br><br><hr><br><br><br>
	  <h2>1. int()</h2><br><br>
 <p id="content_p">We have converted the float value 1.0 to the interger value one.</p>   
<br><br><br>
<div class="box">
...
1
    ...
    <h2>2. float()</h2><br><br>
  <p id="content_p">We have converted the integer value 1 to the float value 1.0.</p>
<br>
<div class="box">
  <div class="heading">Example</div>
    <div class="src">
...
<p id="content_p">We have converted the integer value 1 to the string value "1". Next we have converted the float value 2.0 to the string value "2.0".</p>    
<br>
<div class="box">
  <div class="heading">Example</div>
    <div class="src">
