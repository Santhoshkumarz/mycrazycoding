...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>string upper in python</title>
...
<a class="active" href="py_method_string_upper().php">string upper()</a>
...
<h1 id="problemhead">string.upper() in python</h1><br><br>
<p id="content_p">String upper is used to convert the given string into uppercase character.</p>
<br><br><br>
