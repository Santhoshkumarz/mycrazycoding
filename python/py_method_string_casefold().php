...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>string casefold in python</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="casefold in python, casefold in python example, how to use casefold in python, string casefold, string casefold python, use of casefold in python, what is casefold in python, string casefold in python, string casefold in python in mycrazycoding, string casefold in mycrazycoding">
...
<a class="active" href="py_method_string_casefold().php">string casefold()</a>
...
<h1 id="problemhead">string.casefold() in python</h1><br><br>

<p id="content_p">String casefold is used to convert the given string into lowercase character.</p>
