...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>for else in python</title>
...
<div class="sidebar" id="side">
  ...
  <a class="active" href="py_basic_for_else.php" id="A" ><i class="fas fa-arrow-alt-circle-right"></i> for else</a>
...
<h1 id="problemhead">for else in python</h1><br>
<br>
