...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>string startswith in python</title>
...
<a class="active" href="py_method_string_startswith().php">string startswith()</a>
...
<h1 id="problemhead">string.startswith() in python</h1><br><br>
<p id="content_p">String startswith is used to check the given single character or set of character starting with the given string or not.</p>
<br><br><br>
