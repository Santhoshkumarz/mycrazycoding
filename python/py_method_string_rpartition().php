...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>string rpartition in python</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="string partition in python, string partition python example, string rpartition in python, string rpartition python example, string rpartition in python in mycrazycoding, string rpartition in mycrazycoding">
...
<a class="active" href="py_method_string_rpartition().php">string rpartition()</a>
...
<h1 id="problemhead">string.rpartition() in python</h1><br> <br>
<p id="content_p">String rpartition is used to split the given single character or set of character in the right side of the given string. </p>
<br> <br> <br>
<h2>Syntax:</h2> <br> <br>
<div class="syntax">
<pre>
string.rpartition(character)
</pre>
