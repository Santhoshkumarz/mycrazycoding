...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Keyword arguments function in python</title>
...
<div class="sidebar" id="side">
  ...
  <hr>
    ...
    <a  class="active" href="py_function_Keyword_arguments.php"  id="A"><i class="fas fa-arrow-alt-circle-right"></i> Keyword arguments function</a>
...
<h1 id="problemhead">Keyword arguments function in python</h1><br>
<br>
<p id="content_p">Keyword arguments will pass the parameters in a key, value format. In this order of the parameter will not be consider.</p>
...
<div class="syntax">
<pre>
def function_name( argument name ):
...
function_name( argument name = value )
</pre>  
</div>
