...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Search in Regular Expression python</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta name="keywords" content="how to search a string using regular expression in python,how to search regular expression in python,python search and replace in file regular expression,python search for regular expression in string,python search regular expression in file,python search regular expression in string,regular expression in python re.search,regular expression search python example,regular expression to search for anything in square brackets python,search and replace using regular expression in python,search for regular expression in list python,search for regular expression in python,search for regular expression in string python,search in regular expression in python,search method in regular expression python,search regex in text python,search regular expression in file python,search regular expression in list python,search regular expression in python,search using regular expression in python,search with regular expression in python,search in python in mycrazyding">
...
<h1 id="problemhead">Search in python</h1><br><br>

<p id="content_p">"search" is one of the function of "re" module. This function is used for searching in strings in very fast and efficient manner. While searching it will return when the first "match" object is found in the string otherwise it will return none.</p>
...
<h2>Output</h2>
 <br><br>
    <div id="output">
<pre>
&ltre.Match object; span=(6, 13), match='Minions'>
</pre>
