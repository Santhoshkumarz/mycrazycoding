...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>while else in python</title>
...
<div class="sidebar" id="side">
  ...
  <a class="active" href="py_basic_while_else.php" id="A" ><i class="fas fa-arrow-alt-circle-right"></i> while else</a>
...
<h1 id="problemhead">while else in python</h1><br>
<br>
<p id="content_p"> "else" block will be executed after the termination of the while loop. If the while loop gets break else block will not be executed.</p>
