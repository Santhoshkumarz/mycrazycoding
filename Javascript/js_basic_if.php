...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>if,if else,else if,... in javascript</title>
...
<h1 id="problemhead">if-statement in javascript</h1>
<br><br>
...
if(a == 5)
{
    ...
    document.write("a value is five");
...
{
     document.write("Greater than three")
}
</pre>
    </div></div>
<br><br>
