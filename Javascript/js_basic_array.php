...
<h1 id="problemhead">Array in javascript</h1>
 <br><br>
<p id="content_p">Array is a collection of elements. The size of the array is fixed. In array elements are stored in an contiguous memory location. Using indexing we can access the array elements. Array index starts with 0,1,2 and so on.</p>
<br><br><hr><br><br>
<h1 id="problemhead">syntax</h1><br><br>
	  <div class="syntax">
	  
<pre>
variable array_name = [ <i>item1, item2,...</i>];
</pre>
